...
export function CategoryTiles({
  ...
  return (
    <div className="relative w-full overflow-hidden py-8">
      ...
      {/* Marquee Container */}
      <div className="flex w-max animate-marquee gap-4 hover:paused mx-auto">
        {/* All Products tile */}
        <Link
          href="/shop"
              ...
              <div className="relative h-32 w-56 sm:h-56 sm:w-80">
                ...
                {imageUrl ? (
                    <Image
                      ...
                      fill
                      className="object-contain transition-transform duration-500 group-hover:scale-110 bg-[#e0e0e1]"
                    />
                ) : (
